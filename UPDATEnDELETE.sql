...
-- 3 Questions on UPDATE Clause  TO update existing Rows 

-- 1. Write a SQL query to update John Doe's salary to 55000.

update Employee1 set salary=55000 where FirstName = "John" ;

update Employee1 set salary=85000 where FirstName like  "%n" ;

-- 3. Update salary of all employee by 10%
Update employee1 set salary =salary +  salary * 0.10;
;



-- 1. Update the salary of employees with 'son' in their last name to 60000.
Update employee1 set salary =60000 where LastName like "%son";

-- 2. Update the salary of employees with 'Evans' in their last name to 58000.
Update employee1 set salary =60000 where LastName = "Evans";

-- 3. Delete employees with a salary between 60000 and 70000.
DELETE FROM employee1 WHERE salary BETWEEN 60000 AND 70000;

-- 4. Update the last name of employees with 'Lee' in their last name to 'Lewis'
Update employee1 set lastname="Lee" where LastName="Lewis";

-- 5. Delete employees with a last name ending with 'son'.
delete from employee1 Where Lastname like "%son"; 

-- 6. Retrieve the details of employees whose first name contains 'a' and last name contains 'o'
select * from employee1 where FirstName like "%a%" AND LastName like "%o%";

-- 7. Write a SQL query to delete all employees with a salary less than 40000.
delete from employee1 where salary <4000;


-- 8. Write a SQL query to delete employees with a last name starting with 'A'.
delete from employee1 where LastName like "A%";
